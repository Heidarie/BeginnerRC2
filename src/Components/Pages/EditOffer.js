...
export default function Addoffer() {
  ...
  const getOfferDetails = async (offers) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setTags(getLanguages(data, response.data.languages));
      })
      .catch((err) => {
        console.log(err);
      });
  ...
  function getLanguages(dataLang, offerLang) {
    ...
    for (let i = 0; i < dataLang.length; i++) {
      for (let x = 0; x < offerLang.length; x++) {
        if (dataLang[i].name === offerLang[x]) {
          res.push(dataLang[i]);
        }
      }
    }
  ...
  const onSubmit = async (data, e) => {
    ...
    const dataToSend = {
      ...
      EmployerName: offerShow.employerName,
    ...
    await axios
      .post("https://localhost:44310/Offer/EditOffer", dataToSend, {
        headers: config,
      })
      .then((response) => {
                  ...
                  <Row className="">
                    <Col className="col-12 justify-content-center justify-content-lg-start">
                      ...
                      >
                        ...
                        <Form.Control
                          type="text"
                          size="lg"
                          defaultValue={offerShow.offerName}
                          placeholder="Tytuł"
                    ...
                    <Col className="col-12 px-5 justify-content-center">
                      ...
                      >
                        ...
                        <Form.Control
                          type="text"
                          defaultValue={offerShow.profession}
                    ...
                    <Col className="col-5 d-flex justify-content-center w-75">
                      ...
                      >
                        <Form.Control
                          type="number"
                          placeholder="Średnia"
                          defaultValue={offerShow.companySize}
                          className="rounded rounded-pill border border-light text-center"
                    ...
                    <Col className="col-5 col-xl-6 justify-content-center ">
                      ...
                      >
                        <Form.Control
                          type="number"
                          placeholder="Od"
                          defaultValue={offerShow.salaryFrom}
                          className="rounded rounded-pill border border-light text-center"
                    ...
                    <Col className="col-5 col-xl-6 justify-content-center ">
                      ...
                      >
                        <Form.Control
                          type="number"
                          placeholder="Do"
                          defaultValue={offerShow.salaryTo}
                          className="rounded rounded-pill border border-light text-center"
                          {...register("income_to", {
                            required:
                ...
                <Col className="col-12">
                  ...
                  >
                    ...
                    >
                      ...
                      <Form.Control
                        as="textarea"
                        defaultValue={offerShow.description}
                        rows={3}
